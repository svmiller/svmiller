...
|:----------|:-----------:|:--------------------|
| [`{codename}`](http://svmiller.com/codename) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/codename)](https://cran.r-project.org/package=codename) | generate unique code names for things (comes in various styles, like [Ubuntu](https://en.wikipedia.org/wiki/Ubuntu_version_history#Naming_convention) and [Wu-Tang](https://www.mess.be/inickgenwuname.php)) |
| [`{dragracer}`](https://github.com/svmiller/dragracer) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/dragracer)](https://cran.r-project.org/package=dragracer) | learn R functions around data from RuPaul's Drag Race |
| [`{fpsim}`](https://github.com/svmiller/fpsim) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/fpsim)](https://cran.r-project.org/package=fpsim) | calculate various measures of association/similarity, with IR applications |
| [`{isard}`](https://github.com/svmiller/isard) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/isard)](https://cran.r-project.org/package=isard) | overflow data for [`{peacesciencer}`](http://svmiller.com/peacesciencer)  |
| [`{peacesciencer}`](http://svmiller.com/peacesciencer) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/peacesciencer)](https://cran.r-project.org/package=peacesciencer)| data generation tools for quantitative peace science (an R analog to [EUGene](https://www.tandfonline.com/doi/abs/10.1080/03050620008434965?casa_token=-fany9aop7QAAAAA:AFUqdPivrRDCwrAjIrx0trABUQhNfSuPU1lROzjQqluNSa8Lo5VO17GEOC76zxNczMC8PiSumAn9))  |
| [`{simqi}`](http://svmiller.com/simqi) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/simqi)](https://cran.r-project.org/package=simqi) |  simulate “quantities of interest” from regression models |
| [`{stevedata}`](http://svmiller.com/stevedata) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/stevedata)](https://cran.r-project.org/package=stevedata) |   miscellaneous data sets I use for in-class instruction |
| [`{stevemisc}`](http://svmiller.com/stevemisc) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/stevemisc)](https://cran.r-project.org/package=stevemisc) |  various helper functions for research and presentation (esp. for mixed models and BTSCS models) |
| [`{steveproj}`](http://svmiller.com/steveproj) |  | a Make and R Markdown approach to academic project management |
| [`{stevetemplates}`](http://svmiller.com/stevetemplates) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/stevetemplates)](https://cran.r-project.org/package=stevetemplates) |  write R Markdown documents with [my suite of R Markdown templates](https://github.com/svmiller/svm-r-markdown-templates) |
| [`{stevethemes}`](http://svmiller.com/stevethemes/) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/stevethemes)](https://cran.r-project.org/package=stevethemes) |  a collection of `{ggplot2}` themes and theme elements |
| [`{sTSD}`](http://svmiller.com/) |  [![](https://cranlogs.r-pkg.org/badges/grand-total/sTSD)](https://cran.r-project.org/package=sTSD) | tools for simulating unit root tests for time series data |
